...
public class Decrypt extends JFrame {
	...
	public Decrypt() {
		...
		JLabel lblNewLabel_1 = new JLabel("Message to Decrypt");
		...
		decrypt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 ...
				 String secret;
			        ...
			        try {
			            secret = key.getText();
			            strToDecrypt = textMsg.getText();
			            // setKey(secret);
			            text2.setText(new String(decrypt(Base64.getDecoder().decode(strToDecrypt), secret.getBytes("UTF-8"))));
			        } catch (Exception e1) {
			            text2.setText("Please fill up the right secret key");
			        }
			}
		});
		decrypt.setFont(new Font("Tahoma", Font.PLAIN, 15));
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addComponent(scrollPane_2, GroupLayout.PREFERRED_SIZE, 606, GroupLayout.PREFERRED_SIZE)
		...
		scrollPane_2.setViewportView(text2);
		text2.setColumns(10);
